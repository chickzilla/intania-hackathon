          ...
          <GridCol h="95vh" span={{ base: 12, md: 6 }}>
            <Stack h="100%" align="stretch" justify="center" gap="md">
              ...
              <Text>
                ...
                skills, compete in challenges, and climb the global leaderboard.
              </Text>
              <Group>
                <Button
                  color="red.8"
          ...
          <Grid grow gutter="xl">
            ...
            <GridCol span={{ base: 12, sm: 6, md: 4 }}>
              <Paper p="lg" radius="md" shadow="sm" mih="10rem" h="100%">
                ...
                <Text c="gray">
                  Connect with learners worldwide, collaborate on projects, and
                  share knowledge in our community forums.
                </Text>
              </Paper>
            </GridCol>
            <GridCol span={{ base: 12, sm: 6, md: 4 }}>
              <Paper p="lg" radius="md" shadow="sm" mih="10rem" h="100%">
                ...
                <Text c="gray">
                  Build your portfolio with real-world projects that demonstrate
            ...
            <GridCol span={{ base: 12, sm: 6, md: 4 }}>
              <Paper p="lg" radius="md" shadow="sm" mih="10rem" h="100%">
                <ThemeIcon
                  ...
                  mb="sm"
                >
                  <IconDeviceGamepad style={{ width: "70%", height: "70%" }} />
                </ThemeIcon>
                <Text size="xl" fw={700}>
                  Gamified Learning
                </Text>
